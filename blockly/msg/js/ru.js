...
Blockly.Msg.ARD_MD_SERVOCON_BOTTOM = "Defineer onder:";  // untranslated
Blockly.Msg.ARD_MD_SERVOCON_TIP = "Servo Motor Connector, kan twee servo sturen (boven en onder). Een servo dien je een naam te geven, en het type op te geven (geen servo, 180 graden servo of 360 graden servo)";  // untranslated
Blockly.Msg.ARD_MD_SERVOCON_TOP = "Defineer boven:";  // untranslated
Blockly.Msg.ARD_MD_SERVOCON_TYPE = "Type:";  // untranslated
Blockly.Msg.ARD_MD_SERVOTYPE_TIP = "Selecteer het type Servo die je koppelt aan de Servo connnector";  // untranslated
